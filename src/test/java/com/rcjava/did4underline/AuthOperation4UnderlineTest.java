...
public class AuthOperation4UnderlineTest extends Did4UnderlineTest {

    public AuthOperation4UnderlineTest() throws IOException {
    }
    ...
    void testGrantOperate_1() throws InterruptedException, InvalidProtocolBufferException {
        ...
        Peer.Authorize authorize = Peer.Authorize.newBuilder()
                ...
                .addOpId(DigestUtils.sha256Hex("identity-net:CredenceTPL_underline.deploy"))
    ...
    void testSignUpOperate_1() throws IOException, InterruptedException {
        ...
        Peer.ChaincodeId customTplId = Peer.ChaincodeId.newBuilder().setChaincodeName("CredenceTPL_underline").setVersion(2).build();
        String tplString = FileUtils.readFileToString(new File("jks/test/tpl/CredenceTPL_underline.scala"), StandardCharsets.UTF_8);
        ...
        Peer.ActionResult actionResult = checkResult(signedDeployTran.getId());
        ...
        Peer.Operate operate = Peer.Operate.newBuilder()
                .setOpId(DigestUtils.sha256Hex("identity-net:CredenceTPL_underline.creProof2"))
                ...
                .setAuthFullName("identity-net:CredenceTPL_underline.creProof2")
                .setCreateTime(Timestamp.newBuilder().setSeconds(millis / 1000).setNanos((int) ((millis % 1000) * 1000000)).build())
                .setOpValid(true)
                .setVersion("1.0")
                .build();
...
//        authStatus.put("authId", "edb8bad3-2d2c-4bef-bc0f-93a297571ac6");
    ...
    void testGrantOperate_3() throws InterruptedException, InvalidProtocolBufferException {
        ...
        Peer.Operate operate = Peer.Operate.newBuilder()
                .setOpId(DigestUtils.sha256Hex("identity-net:CredenceTPL_underline.creProof"))
                .setDescription("测试注册合约某个方法")
                .setRegister(user1_creditCode_did)
                .setIsPublish(false)
                .setOperateType(Peer.Operate.OperateType.OPERATE_CONTRACT)
                // 貌似没必要？
                .addAllOperateServiceName(Arrays.asList("transaction.stream", "transaction.postTranByString", "transaction.postTranStream", "transaction.postTran"))
                .setAuthFullName("identity-net:CredenceTPL_underline.creProof")
        ...
        Peer.ActionResult actionResult_0 = checkResult(tranId_0);
        ...
        Peer.ChaincodeId credenceTPLId = Peer.ChaincodeId.newBuilder().setChaincodeName("CredenceTPL_underline").setVersion(2).build();
        String tranId = UUID.randomUUID().toString();
        ...
        Peer.Authorize authorize_1 = Peer.Authorize.newBuilder()
                .setGrant(user0_creditCode_did)
                .addOpId(DigestUtils.sha256Hex("identity-net:CredenceTPL_underline.creProof"))
                .setIsTransfer(Peer.Authorize.TransferType.TRANSFER_REPEATEDLY)
                .setCreateTime(Timestamp.newBuilder().setSeconds(millis / 1000).setNanos((int) ((millis % 1000) * 1000000)).build())
                .setAuthorizeValid(true)
                .setVersion("1.0")
        ...
        String tranId_3 = UUID.randomUUID().toString();
        Peer.ChaincodeId credenceTPLId_1 = Peer.ChaincodeId.newBuilder().setChaincodeName("CredenceTPL_underline").setVersion(1).build();
    ...
    void testUpdateOperateStatus_1() throws InterruptedException, InvalidProtocolBufferException {
        ...
        operStatus.fluentPut("opId", DigestUtils.sha256Hex("identity-net:CredenceTPL_underline.creProof")).fluentPut("state", false);
        ...
        operStatus.fluentPut("opId", DigestUtils.sha256Hex("identity-net:CredenceTPL_underline.creProof")).fluentPut("state", true);
        ...
        Peer.ActionResult actionResult_5 = checkResult(tranId_5);
    ...
    void testUpdateGrantOperateStatus_2() throws InterruptedException, InvalidProtocolBufferException {
        ...
        Peer.Authorize authorize_1 = Peer.Authorize.newBuilder()
                ...
                .addOpId(DigestUtils.sha256Hex("identity-net:CredenceTPL_underline.creProof2"))
                .setIsTransfer(Peer.Authorize.TransferType.TRANSFER_REPEATEDLY)
                .setCreateTime(Timestamp.newBuilder().setSeconds(millis / 1000).setNanos((int) ((millis % 1000) * 1000000)).build())
                .setAuthorizeValid(true)
                .setVersion("1.0")
    ...
    void testUpdateOperateStatus_3() throws InterruptedException, InvalidProtocolBufferException {
        ...
        String tranId_1 = UUID.randomUUID().toString();
        JSONObject operStatus = new JSONObject();
        operStatus.fluentPut("opId", DigestUtils.sha256Hex("identity-net:CredenceTPL_underline.creProof2")).fluentPut("state", false);
