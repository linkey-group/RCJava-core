...
public class OperOperation4UnderlineTest extends Did4UnderlineTest {
    public OperOperation4UnderlineTest() throws IOException {
    }
    ...
    void testSignUpOperate_1() throws InterruptedException, InvalidProtocolBufferException {
        ...
        Peer.Operate operate = Peer.Operate.newBuilder()
                .setOpId(DigestUtils.sha256Hex(did_network_id + "service_1_" + UUID.randomUUID()))
                .setDescription("测试用的service")
                .setRegister(super_creditCode)
                .setIsPublish(false)
                .setOperateType(Peer.Operate.OperateType.OPERATE_SERVICE)
                .addOperateServiceName(did_network_id + "service_1_" + UUID.randomUUID())
    ...
    void testSignUpOperate_2() throws InterruptedException, InvalidProtocolBufferException {
        ...
        long millis = System.currentTimeMillis();
        Peer.Operate operate = Peer.Operate.newBuilder()
                .setOpId(DigestUtils.sha256Hex("identity-net:CredenceTPL_underline.deploy"))
    ...
    void testDeployContract() throws IOException, InterruptedException {
        ...
        Peer.ChaincodeId customTplId = Peer.ChaincodeId.newBuilder().setChaincodeName("CredenceTPL_underline").setVersion(1).build();
        ...
        Peer.Operate operate = Peer.Operate.newBuilder()
                ...
                // 貌似没必要？
                .addAllOperateServiceName(Arrays.asList("transaction.stream", "transaction.postTranByString", "transaction.postTranStream", "transaction.postTran"))
                .setAuthFullName("identity-net:CredenceTPL_underline.deploy")
        ...
        Peer.Authorize authorize_1 = authorize.toBuilder().clearOpId().addOpId(DigestUtils.sha256Hex("identity-net:CredenceTPL_underline.deploy")).build();
        ...
        Peer.ActionResult actionResult_4 = checkResult(signedDeployTran_1.getId());
    ...
    void testSignUpOperate_4() throws InterruptedException, InvalidProtocolBufferException {
        ...
        long millis = System.currentTimeMillis();
        Peer.Operate operate = Peer.Operate.newBuilder()
                .setOpId(DigestUtils.sha256Hex("identity-net:CredenceTPL_2.creProof"))
                ...
                // 貌似没必要？
                .addAllOperateServiceName(Arrays.asList("transaction.stream", "transaction.postTranByString", "transaction.postTranStream", "transaction.postTran"))
                .setAuthFullName("identity-net:CredenceTPL_2.creProof")
                .setCreateTime(Timestamp.newBuilder().setSeconds(millis / 1000).setNanos((int) ((millis % 1000) * 1000000)).build())
                .setOpValid(true)
                .setVersion("1.0")
                .build();
    ...
    void testSignUpOperate_5() throws InterruptedException, InvalidProtocolBufferException {
        ...
        long millis = System.currentTimeMillis();
        Peer.Operate operate = Peer.Operate.newBuilder()
                .setOpId(DigestUtils.sha256Hex("identity-net:CredenceTPL_underline.creProof-not-exists"))
                .setDescription("测试注册合约某个方法")
                .setRegister(user0_creditCode_did)
                .setIsPublish(true)
                .setOperateType(Peer.Operate.OperateType.OPERATE_CONTRACT)
    ...
    String testCredenceProof() throws InterruptedException {
        ...
        Peer.ChaincodeId credenceTPLId = Peer.ChaincodeId.newBuilder().setChaincodeName("CredenceTPL_underline").setVersion(1).build();
        String tranId = UUID.randomUUID().toString();
