...
public class CertOpeartionTest extends DidTest {
    ...
    void testSignUpCert_1() throws IOException, InterruptedException {
        ...
        Peer.Certificate usr1_cert_0 = getUsrCert(user1_creditCode_did, user1_cert_0);
    ...
    void testSignUpCert_2() throws IOException, InterruptedException {
        Peer.Certificate usr0_cert = getUsrCert(user0_creditCode_did, user0_cert_0);
        String tranId = UUID.randomUUID().toString();
    ...
    void testSignUpCert_3() throws IOException, InterruptedException {
        // 构造一个不同的证书
        Peer.Certificate usr0_cert_1 = getUsrCert(user0_creditCode_did, user0_cert_1).toBuilder().setCertHash("test").build();
        String tranId = UUID.randomUUID().toString();
    ...
    void testSignUpCert_4() throws IOException, InterruptedException {
        // 构造一个不同的证书
        Peer.Certificate usr0_cert_1 = getUsrCert(user0_creditCode_did, user0_cert_1).toBuilder()
    ...
    void testSignUpCert_5() throws IOException, InterruptedException {
        // step1: 注册证书
        Peer.Certificate usr0_cert_1 = getUsrCert(user0_creditCode_did, user0_cert_1);
        String tranId = UUID.randomUUID().toString();
        Peer.Transaction tran = usr0_tranCreator_0.createInvokeTran(tranId, usr0_certId_0, didChaincodeId, signUpCertificate, JsonFormat.printer().print(usr0_cert_1), 0, "");
        postClient.postSignedTran(tran);
        Peer.ActionResult actionResult = checkResult(tranId);
        Assertions.assertEquals(0, actionResult.getCode(), "没有错误，注册成功");
    ...
    void testUpdateCertificateStatus_1() throws InterruptedException {
        ...
        certStatus.fluentPut("creditCode", "identity-net:usr-xxx").fluentPut("certName", user0_cert_1).fluentPut("state", false);
    ...
    void testUpdateCertificateStatus_3() throws InterruptedException {
        ...
        JSONObject certStatus = new JSONObject();
        // 修改身份证书状态
        certStatus.fluentPut("creditCode", user0_creditCode_did).fluentPut("certName", user0_cert_0).fluentPut("state", false);
        Peer.Transaction tran = usr0_tranCreator_0.createInvokeTran(tranId, usr0_certId_0, didChaincodeId, updateCertificateStatus, certStatus.toJSONString(), 0, "");
        postClient.postSignedTran(tran);
        Peer.ActionResult actionResult = checkResult(tranId);
        Assertions.assertEquals(102, actionResult.getCode(), "错误码为102");
    ...
    void testSignUpAllTypeCert_1() throws IOException, InterruptedException {
        ...
        Peer.Certificate usr1_cert_1 = getUsrCert(user1_creditCode_did, user1_cert_1);
        String tranId = UUID.randomUUID().toString();
    ...
    void testSignUpAllTypeCert_3() throws IOException, InterruptedException {
        ...
        Peer.ActionResult tranResult_1 = checkResult(tranId_1);
        Assertions.assertEquals(0, tranResult_1.getCode(), "没有错误，修改成功");
    }
    ...
    void testSignUpAllTypeCert_4() throws IOException, InterruptedException {
        ...
        Peer.Certificate usr2_cert_1 = getUsrCert(user2_creditCode_did, user2_cert_1);
        String tranId = UUID.randomUUID().toString();
        ...
        Assertions.assertEquals(0, tranResult_3.getCode(), "没有错误，注册成功");
        ...
        Peer.ActionResult tranResult_4 = checkResult(tranId_4);
        Assertions.assertEquals(0, tranResult_4.getCode(), "没有错误，修改成功");
    ...
    void testUpdateAllTypeCertificateStatus_1() throws IOException, InterruptedException {
        ...
        String tranId_1 = UUID.randomUUID().toString();
        JSONObject certStatus = new JSONObject();
        certStatus.fluentPut("creditCode", user2_creditCode_did).fluentPut("certName", user2_cert_1).fluentPut("state", true);
