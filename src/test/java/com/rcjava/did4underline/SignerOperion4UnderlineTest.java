...
public class SignerOperion4UnderlineTest extends Did4UnderlineTest {

    String user0_pem_0 = new String(Files.readAllBytes(new File(String.format("jks/test/did4Underline/%s_%s.cer", user0_creditCode_did.split(":")[1], user0_cert_0)).toPath()));
    String user1_pem_0 = new String(Files.readAllBytes(new File(String.format("jks/test/did4Underline/%s_%s.cer", user1_creditCode_did.split(":")[1], user1_cert_0)).toPath()));
    String user2_pem_0 = new String(Files.readAllBytes(new File(String.format("jks/test/did4Underline/%s_%s.cer", user2_creditCode_did.split(":")[1], user2_cert_0)).toPath()));

    public SignerOperion4UnderlineTest() throws Exception {
    }
